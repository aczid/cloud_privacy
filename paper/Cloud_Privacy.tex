...
\date{\today}
\abstract{We review our concerns for observed and potential privacy risks associated with cloud computing in a broad sense. We summarize the positive and negative aspects regarding security, the legal aspects concerning data protection and the state of affairs with regard to personal cloud storage services (so-called `cyberlockers' and their privacy protection technologies. We end with a summary of two related and applicable privacy-enhancing technologies uncovered in our literature study, and give our reflection on the perceived state of affairs as a conclusion to the study.}
