...
Note that we shall not attempt to describe any given concept with the greatest level of (mathematical) detail, instead we shall focus on supplying the intuition for how we can use these technologies to aid in our endeavour to make clouding computing more friendly to our privacy.
